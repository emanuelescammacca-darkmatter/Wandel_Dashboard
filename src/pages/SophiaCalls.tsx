...
const CALLS: SophiaCall[] = [
  { id: '1',  date: '2026-04-10', time: '09:12', duration: null,   candidateName: 'Marcel Weber',         client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'no-answer',      disposition: 'no-answer',         hasAudio: false },
  { id: '2',  date: '2026-04-10', time: '09:15', duration: null,   candidateName: 'Marcel Weber',         client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'voicemail-left',  disposition: 'voicemail',          hasAudio: false },
  { id: '3',  date: '2026-04-11', time: '10:30', duration: '0:48', candidateName: 'Andi Kufner',          client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'client-ended',   disposition: 'live-conversation',  hasAudio: true  },
  { id: '4',  date: '2026-04-11', time: '11:05', duration: '4:23', candidateName: 'Andi Kufner',          client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'completed',      disposition: 'live-conversation',  hasAudio: true  },
  { id: '5',  date: '2026-04-12', time: '08:44', duration: null,   candidateName: 'Udo Alexander Brandt', client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'voicemail-left',  disposition: 'voicemail',          hasAudio: false },
  { id: '6',  date: '2026-04-12', time: '14:20', duration: '1:15', candidateName: 'Udo Alexander Brandt', client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'client-ended',   disposition: 'live-conversation',  hasAudio: true  },
  { id: '7',  date: '2026-04-13', time: '09:00', duration: null,   candidateName: 'Andreas Gottschalk',   client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'no-answer',      disposition: 'company-line',       hasAudio: false },
  { id: '8',  date: '2026-04-13', time: '09:30', duration: null,   candidateName: 'Andreas Gottschalk',   client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'no-answer',      disposition: 'no-answer',          hasAudio: false },
  { id: '9',  date: '2026-04-13', time: '14:00', duration: '2:48', candidateName: 'Andreas Gottschalk',   client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'completed',      disposition: 'live-conversation',  hasAudio: true  },
  { id: '10', date: '2026-04-14', time: '15:30', duration: '1:02', candidateName: 'Giovanni Rossi',       client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'client-ended',   disposition: 'live-conversation',  hasAudio: true  },
  { id: '11', date: '2026-04-14', time: '16:15', duration: null,   candidateName: 'Giovanni Rossi',       client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'voicemail-left',  disposition: 'voicemail',          hasAudio: false },
  { id: '12', date: '2026-04-15', time: '10:15', duration: '0:32', candidateName: 'Niclas Gallas',        client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'voicemail-left',  disposition: 'voicemail',          hasAudio: true  },
  { id: '13', date: '2026-04-16', time: '09:30', duration: '5:10', candidateName: 'Klaus Müller',         client: 'LogiHub GmbH',     position: 'Lagerlogistiker',                      agent: 'Sophia', status: 'transferred',    disposition: 'live-conversation',  hasAudio: true  },
  { id: '14', date: '2026-04-16', time: '11:00', duration: null,   candidateName: 'Klaus Müller',         client: 'LogiHub GmbH',     position: 'Lagerlogistiker',                      agent: 'Sophia', status: 'no-answer',      disposition: 'no-answer',          hasAudio: false },
  { id: '15', date: '2026-04-17', time: '13:45', duration: null,   candidateName: 'Sophie Bauer',         client: 'Office Direct AG', position: 'Bürokauffrau',                         agent: 'Sophia', status: 'no-answer',      disposition: 'busy',               hasAudio: false },
  { id: '16', date: '2026-04-20', time: '10:00', duration: '3:10', candidateName: 'Klaus Müller',         client: 'LogiHub GmbH',     position: 'Lagerlogistiker',                      agent: 'Sophia', status: 'completed',      disposition: 'live-conversation',  hasAudio: true  },
  { id: '17', date: '2026-04-21', time: '14:00', duration: null,   candidateName: 'Sophie Bauer',         client: 'Office Direct AG', position: 'Bürokauffrau',                         agent: 'Sophia', status: 'failed',         disposition: 'company-line',       hasAudio: false },
  { id: '18', date: '2026-04-22', time: '09:05', duration: null,   candidateName: 'Marcel Weber',         client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'no-answer',      disposition: 'wrong-contact',      hasAudio: false },
  { id: '19', date: '2026-04-24', time: '15:30', duration: '3:15', candidateName: 'Giovanni Rossi',       client: 'Jura GmbH',        position: 'Servicetechniker für Kaffeeautomaten', agent: 'Sophia', status: 'client-ended',   disposition: 'live-conversation',  hasAudio: true  },
  { id: '20', date: '2026-04-25', time: '11:20', duration: '1:48', candidateName: 'Sophie Bauer',         client: 'Office Direct AG', position: 'Bürokauffrau',                         agent: 'Sophia', status: 'completed',      disposition: 'live-conversation',  hasAudio: true  },
];
...
export default function SophiaCalls() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-white">
      ...
      {/* ── Header — full-width border at bottom ── */}
      <div className="shrink-0 border-b border-gray-200">
        <div className="px-6 pt-4 pb-3">

          {/* Title */}
          <h1 className="text-lg font-semibold text-gray-900 mb-3">Sophia Calls</h1>

          {/* ── Unified filter box — fills available width, each section flex-shrinks ── */}
          <div className="flex items-stretch border border-gray-200 rounded-lg bg-white divide-x divide-gray-200 shadow-xs min-w-0">

            {/* Search — given 2× flex weight so it absorbs most spare space */}
            ...
            {/* Disposition — given 1.5× weight; "All Dispositions" is the longest label */}
      ...
      <div className="flex-1 overflow-y-auto overflow-x-auto">
        <table className="w-full text-[13px]" style={{ borderCollapse: 'separate', borderSpacing: 0 }}>
          ...
          {/* Column order: Date · Time · Duration · Recording · Status · Candidate · Client · Position · Agent · Disposition */}
          <thead>
